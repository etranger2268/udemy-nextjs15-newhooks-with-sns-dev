        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="#" className="flex items-center gap-2" prefetch={false}>
              ...
              <span className="hidden md:block text-muted-foreground">John Doe</span>
            </Link>
          </div>
        </div>
      </header>
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
              ...
              <div className="space-y-2">
                <p>
                  Excited to share my latest project with you all! Check it out and let me know what
                  you think.
                </p>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
              ...
              <div className="space-y-2">
                <p>Enjoying the beautiful weather today! Who's up for a hike later?</p>
              </div>
              <div className="flex items-center justify-between mt-4">
                <div className="flex items-center gap-2">
                  <Button variant="ghost" size="icon">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="bg-muted px-2 py-1 rounded-full text-xs">12.3K</span>
              </Link>
              <Link
                href="#"
                className="flex items-center justify-between text-muted-foreground hover:text-primary"
              ...
              >
                <span>#travel</span>
                <span className="bg-muted px-2 py-1 rounded-full text-xs">8.7K</span>
              </Link>
              <Link
                href="#"
                className="flex items-center justify-between text-muted-foreground hover:text-primary"
              ...
              >
                <span>#fashion</span>
                <span className="bg-muted px-2 py-1 rounded-full text-xs">6.2K</span>
              </Link>
              <Link
                href="#"
                className="flex items-center justify-between text-muted-foreground hover:text-primary"
              ...
              >
                <span>#food</span>
                <span className="bg-muted px-2 py-1 rounded-full text-xs">9.5K</span>
              </Link>
            </div>
          </div>
        </div>
